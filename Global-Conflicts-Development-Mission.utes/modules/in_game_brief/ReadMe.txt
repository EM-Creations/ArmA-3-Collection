...
3) For each setup zone you want to create, place a gamelogic in the center of the desired area, and add the following to it's init: script = [this, size of zone, side of players to be contained] execVM "modules\in_game_brief\scripts\sandi_barrier\setup.sqf";
Example - script = [this, 180, east] execVM "in_game_brief\scripts\sandi_barrier\setup.sqf";
